...
def format_response(status = 200, error_msg = None, payload = None):
    response = {'status': status, 'errorMsg': error_msg, 'payload': payload}
    return response
    
def init_response():
    return {'status': None, 'errorMsg': None, 'payload': None}
